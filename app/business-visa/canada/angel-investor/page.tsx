...
const requirements = [
  {
    ...
    value: "$75,000 CAD",
    detail: "You must secure a minimum investment of $75,000 from a designated Angel Investor group.",
    icon: DollarSign
  },
  {
    title: "Business Experience",
    value: "Qualifying Business",
    detail: "You must demonstrate that your business is innovative and that you have the skills to manage it actively in Canada.",
    icon: Briefcase
  },
  {
    title: "Designated Organization",
    value: "Letter of Support",
    detail: "A mandatory commitment certificate from a designated Angel group proving they support your venture.",
    icon: FileCheck
  }
];
...
const faqs = [
  {
    ...
    answer: "While it is not mandatory, it is highly recommended. The process involves complex legal agreements between you and the Angel group, as well as strict immigration protocols. A qualified consultant ensures your application is complete and accurate."
  },
  {
    question: "What kind of commitment do I need?",
    answer: "You need a formal agreement from a designated Angel Investor group confirming they are investing a minimum of $75,000 CAD into your qualifying business. This generates the Letter of Support required by the government."
  }
];
    ...
    <div className="min-h-screen bg-primary text-white selection:bg-gold selection:text-primary font-sans">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              The <strong>Canada Angel Investor Visa</strong> is a premier stream within the Start-Up Visa program, aimed at attracting skilled business professionals ready to launch innovative companies.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              By securing an investment of at least <strong>$75,000 CAD</strong> from a designated Angel Investor group, entrepreneurs can fast-track their permanent residency while gaining invaluable mentorship and capital.
            </p>
      ...
      <section className="py-20 bg-primary border-t border-white/5">
        <div className="container mx-auto ">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">Why entrepreneurs choose the Angel stream.</p>
          </div>
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto  relative z-10">
           <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white">Program <span className="text-gold">Requirements</span></h2>
           </div>

           <div className="grid lg:grid-cols-3 gap-8">
              {requirements.map((req, idx) => (
                 <div key={idx} className="bg-primary-light/5 p-8 rounded-sm border border-white/5 hover:border-gold/30 transition-colors text-center">
                    ...
                    <h3 className="text-gray-400 text-xs font-bold uppercase tracking-wider mb-2">{req.title}</h3>
                    <div className="text-2xl font-bold text-white mb-4">{req.value}</div>
        ...
        <div className="container mx-auto  flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Navigating the Angel Investor landscape requires more than just a business idea; it requires a strategic approach to designated organizations.
            </p>
            <ul className="space-y-4 mb-8">
               <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold shrink-0 mt-1" />
                  <span className="text-gray-400 text-sm">Assessing your personal circumstances to determine the best route.</span>
               </li>
               <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold shrink-0 mt-1" />
                  <span className="text-gray-400 text-sm">Preparing and submitting your application to IRCC.</span>
               </li>
               <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold shrink-0 mt-1" />
                  <span className="text-gray-400 text-sm">Advertising the investment if required by specific Angel groups.</span>
               </li>
               <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold shrink-0 mt-1" />
                  <span className="text-gray-400 text-sm">Liaising with relevant authorities to keep you updated.</span>
               </li>
            </ul>
              ...
              {faqs.map((faq, idx) => (
                <div key={idx} className="border border-white/10 rounded-sm overflow-hidden">
                  <button 
                    ...
                    className="w-full flex justify-between items-center p-4 bg-primary hover:bg-white/5 transition-colors text-left"
                  >
                  ...
                  {openFaq === idx && (
                    <div className="p-4 bg-primary-light/5 text-gray-400 text-sm leading-relaxed border-t border-white/5">
                      {faq.answer}
                    </div>
                  )}
                </div>
